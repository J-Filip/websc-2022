    ...
    var GoTrueClient = class {
      ...
      _startAutoRefreshToken(value) {
        ...
        this.refreshTokenTimer = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
          ...
          if (!error)
            this.networkRetries = 0;
          if ((error === null || error === void 0 ? void 0 : error.message) === constants_1.NETWORK_FAILURE.ERROR_MESSAGE && this.networkRetries < constants_1.NETWORK_FAILURE.MAX_RETRIES)
  ...
  "node_modules/@supabase/storage-js/dist/main/lib/StorageBucketApi.js"(exports) {
    ...
    var StorageBucketApi = class {
      constructor(url, headers = {}, fetch2) {
        this.url = url;
        this.headers = Object.assign(Object.assign({}, constants_1.DEFAULT_HEADERS), headers);
        this.fetch = helpers_1.resolveFetch(fetch2);
      }
      listBuckets() {
        return __awaiter(this, void 0, void 0, function* () {
          try {
...
// netlify/functions/get-vote.ts
var get_vote_exports = {};
__export(get_vote_exports, {
  handler: () => handler
});
...
var supabase = (0, import_supabase_js.createClient)(DATABASE_URL, SUPABASE_SERVICE_API_KEY);
var handler = async () => {
  const { data } = await supabase.from("vote").select("*");
...
module.exports = __toCommonJS(get_vote_exports);
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  handler
});
//# sourceMappingURL=get-vote.js.map
